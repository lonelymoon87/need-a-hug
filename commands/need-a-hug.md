Activate the `need-a-hug` skill.

Do not announce the skill name or say that a mode is being used. Comfort first. If there is an active task, let it wait for a moment.
