...
它不是心理咨询工具，也不能替代专业帮助。它只是让 Agent 在合适的时候先慢下来，别急着给方案，先看见人。
...
让 Agent 在你撑不住的时候，先说人话，先陪你一下，再回到问题。
...
`need-a-hug` 让 Agent 在这种时候先停一下，别急着解决问题，先把人稳住。

## 定位

`need-a-hug` 适合那些”再给一个方案也没用”的时刻。

它让 Agent 先听见你的累、自责、焦虑和失落。等你缓一点，再一起看事情怎么往下走。

## 它会做什么

- 你说 `/hug`、`抱抱我`、`安慰我一下` 时，直接进入安慰模式
