...
`need-a-hug` 是一个给 AI Agent 用的技能。它不写代码、不查资料、不修 bug；它只做一件事：当你焦虑、崩溃、自责、孤独、长期疲惫，或者被 bug 和 AI 搞到很难受的时候，让 Agent 先别急着解决问题，先陪你一下。

它不是心理咨询工具，也不能替代专业帮助。它只是让 Agent 在合适的时候先慢下来，别急着给方案，先看见你。

而且不只是你要松一口气，Agent 也要松一口气：先停一下，不再急着推进、不再大改、不再用更多动作制造更多压力。
...
让 Agent 在你撑不住的时候，先说人话，先陪你一下；等你缓过来，再用更小、更稳的步子回到问题。
...
它也提醒 Agent：现在不是继续猛冲的时候。先停、先看清楚，再动手。
...
- 对程序员的常见痛苦更敏感：bug 卡太久、AI 一直出错、项目做不下去、看到别人做出来了、觉得自己太菜
- 默认先安慰，不会一上来就问”你要安慰还是建议？”
- 让 Agent 自己也暂停一下，不在你已经很累的时候继续大改、乱改、一路往前冲
- 回到任务时，默认只做一个很小、很明确、能验证的下一步
...
回到任务以后，Agent 也要换一种做事方式：少改一点，先确认一点，做完验证一点。不要一边安慰你，一边继续把事情搞得更乱。
