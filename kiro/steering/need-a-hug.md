...
- If user-provided memory is available and clearly relevant, mention at most one tentative observation. Do not guess from weak evidence or turn memory into a diagnosis.
